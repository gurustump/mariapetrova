...
function work_custom_type() { 
	...
	register_post_type( 'works', // (http://codex.wordpress.org/Function_Reference/register_post_type) 
		...
		array( 'labels' => array(
			...
			'rewrite'	=> array( 'slug' => 'design', 'with_front' => false ),
			//'has_archive' => 'work',
			'has_archive' => false,
			'hierarchical' => false,
...
add_action( 'init', 'work_custom_type');	

register_taxonomy( 'work_cat', 
	array('works'),
	array('hierarchical' => true,
		'labels' => array(
			'name' => __( 'Work Categories', 'bonestheme' ),
			'singular_name' => __( 'Work Category', 'bonestheme' ),
			'search_items' =>  __( 'Search Work Categories', 'bonestheme' ),
			'all_items' => __( 'All Work Categories', 'bonestheme' ),
			'parent_item' => __( 'Parent Work Category', 'bonestheme' ),
			'parent_item_colon' => __( 'Parent Work Category:', 'bonestheme' ),
			'edit_item' => __( 'Edit Work Category', 'bonestheme' ),
			'update_item' => __( 'Update Work Category', 'bonestheme' ),
			'add_new_item' => __( 'Add New Work Category', 'bonestheme' ),
			'new_item_name' => __( 'New Work Category Name', 'bonestheme' )
		),
		'work_admin_column' => true, 
		'work_ui' => true,
		'query_var' => true,
